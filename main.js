...
Object.keys(dri).forEach((key) => {                                                                                       
	percentages.push({ name: key, value: Math.min(1, current[key].value / dri[key].value) });                             
});                                                                                                                       
...
var dataset = [
	{ name: 'Calories', total: 8124, percent: 67.9 },
	{ name: 'Carbohydrates', total: 1567, percent: 13.1 },
	{ name: 'Proteins', total: 1610, percent: 13.5 },
	{ name: 'Fats', total: 660, percent: 5.5 }
];
...
var color = d3.scale.ordinal()
	.range(["red", "green", "orange", "yellow", "purple"]);
